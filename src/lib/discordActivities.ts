 ...
 */
export async function setRandomShowActivity (clientUser: ClientUser): Promise<void> {
 ...
 */
export function setWatchingActivity (clientUser: ClientUser, show: string): void {
...
export function setTVDBLoadingActivity (clientUser: ClientUser): void {
  clientUser.setActivity('episode data from the TVDB', { type: ActivityType.Playing })
}
