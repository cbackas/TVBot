...
public enum Rules {
    ...
    two("2", "Rule 2: No Spam", "Spam will not be tolerated at all. Excessive letters, emojis, and pictures especially. Use of zalgo text is not allowed in any way. Names with special text that is not available on a traditional keyboard can be changed."),
